...
echo'<form method="post" action="order_Hdelete_now.php" onclick="delete();"><center><table border="1px" width="95%" >
<tr>
...
<td width="8%">'.$phn.'</td>
<td width="8%">'.$address.'</td>
<td width="8%" ><a href="../delete/order_Hdelete_now.php?oid='.$oid.'" >&nbsp <p style="color:red;">Hard Delete</p></a></td>
</tr>
</table></center></form>';
